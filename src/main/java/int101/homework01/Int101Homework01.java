...
public class Int101Homework01 {
   ...
   static void work04UseOfObjectClass() {
    ...
    Person Y = new Person(2);
    System.out.println(X);
    System.out.println(X.getId());
    X.setId(9);
    System.out.println(X);

    BankAccount aX = new BankAccount(1, X);
    BankAccount aY = new BankAccount(2, Y);
    aX.deposit(100000);
    aX.withdraw(50000);
    System.out.println("Owner account is " + aX.getOwner());
    System.out.println("balance = " + aX.getBalance());
    aY.deposit(100000);
    aY.withdraw(20000);
    System.out.println("Owner account is " + aY.getOwner() + " Balance = " + aY.getBalance()) ;
    aX.transfer(50000, aY);
    System.out.println(aX.toString() + " transfer to " + aY.toString());
    System.out.println(aX.getOwner() + "balance = " + aX.getBalance());
    System.out.println(aY.getOwner() + "balance = " + aY.getBalance());
